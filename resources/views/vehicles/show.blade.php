        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                            ...
                            <div class="grid grid-cols-4 gap-2">
                                @foreach ($vehicleImages as $image)
                                    <img src="{{ asset('storage/' . $image->url) }}"
                                        ...
                                        onclick="document.getElementById('mainVehicleImage').src='{{ asset('storage/' . $image->url) }}'">
                                @endforeach
                            </div>
                        @endif
                    @else
                ...
                <div>
                    ...
                    <div class="text-5xl font-bold text-primary mb-8">{{ $vehicle->formatted_price }}</div>
